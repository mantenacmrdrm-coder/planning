...
def main():
    ...
    print("\nImport des données...")
    importer.import_matrice("data/MATRICE.csv")
    importer.import_vidange("data/VIDANGE.csv", incremental=True)
    importer.import_suivi_curatif("data/SUIVI_CURATIF.csv", incremental=True)
